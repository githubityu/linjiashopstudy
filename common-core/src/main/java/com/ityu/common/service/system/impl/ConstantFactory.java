...
public class ConstantFactory implements IConstantFactory {
    ...
    private RoleRepository roleRepository = SpringContextHolder.Companion.getBean(RoleRepository.class);
    private DeptRepository deptRepository = SpringContextHolder.Companion.getBean(DeptRepository.class);
    private DictCache dictCache = SpringContextHolder.Companion.getBean(DictCache.class);
    private DictRepository dictRepository = SpringContextHolder.Companion.getBean(DictRepository.class);
    private UserRepository userRepository = SpringContextHolder.Companion.getBean(UserRepository.class);
    private MenuRepository menuRepository = SpringContextHolder.Companion.getBean(MenuRepository.class);
    private NoticeRepository sysNoticeRepository = SpringContextHolder.Companion.getBean(NoticeRepository.class);
    private ConfigCache configCache = SpringContextHolder.Companion.getBean(ConfigCache.class);

    public static IConstantFactory me() {
        return (IConstantFactory) SpringContextHolder.Companion.getBean("constantFactory");
    }
