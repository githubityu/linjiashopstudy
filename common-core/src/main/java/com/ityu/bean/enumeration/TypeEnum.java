package com.ityu.bean.enumeration;
...
public class TypeEnum {
	...
	public enum InvokeStateEnum {
		...
		InvokeStateEnum(int value, String code) {
			this.value = value;
			this.code = code;
		}
	...
	public enum OrderChannelEnum {
		...
		OrderChannelEnum(int value, String name) {
			this.value = value;
			this.name = name;
		}
	...
	public enum JobStatus {
		...
		JobStatus(String index, String name) {
			this.name = name;
			this.index = index;
		}
