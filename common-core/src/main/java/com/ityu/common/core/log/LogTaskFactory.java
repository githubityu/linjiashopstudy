package com.ityu.common.core.log;


import cn.hutool.extra.spring.SpringUtil;
import com.ityu.common.bean.constant.state.LogSucceed;
import com.ityu.common.bean.constant.state.LogType;
...
public class LogTaskFactory {
    ...
    private static LoginLogRepository loginLogRepository = SpringUtil.getBean(LoginLogRepository.class);
    private static OperationLogRepository operationLogRepository = SpringUtil.getBean(OperationLogRepository.class);
